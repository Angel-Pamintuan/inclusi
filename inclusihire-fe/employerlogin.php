...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt->bind_result($user_id, $fullname, $email, $hashedPassword, $usertype_id);

    if ($stmt->fetch()) {
        if ($usertype_id != 2) { // Assuming 2 is the usertype for employers
            $_SESSION['status'] = "Access denied. You are not an employer.";
            header("Location: employerlogin.php");
            exit();
        }
...
<body>
    <div class="container-fluid">
        ...
        <div class="login">Doesn't have an account? <a href="employerregister.php"
