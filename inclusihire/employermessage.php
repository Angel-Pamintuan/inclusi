                    ...
                    <div class="messages">
                        ...
                        <div class="message-info">
                            <div class="message-header">
                                <div class="username">
                                    <a
                                        href="applicationprogress.php?application_id=<?= $row['application_id'] ?>"><?= htmlspecialchars($row['fullname']) ?></a>
                                </div>
                                <div class="job-status"><?= htmlspecialchars($row['apply_status']) ?></div>
                            </div>
